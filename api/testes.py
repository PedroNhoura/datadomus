...
credentials_path = '/home/pedro/Geral/Estudos/Projeto_Plataforma_DataScience/fogo_cruzado/encoded-density-405819-b95eedf3c89b.json'  # Substitua pelo caminho do seu arquivo JSON de credenciais
...
colunas_desejadas = ['id', 'address', 'state', 'city', 'latitude', 'longitude', 'date', 'victims']
